...
function bancos()
{
  open('bancos.html','_blank','width=618,height=500,scrollbars=yes,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no,close=no');
}
...
// SERVICIOS - SERVICIOS DE INTERNET
...
// SERVICIOS - COORDINACION DE CULTURA
...
function telenotas()
{
  open('telenotas.html','_blank','width=600,height=500,scrollbars=yes,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no');
}

// COMUNIDAD - LOGOS DE CUNIBE
function logosdecunibe()
{
  open('logosdecunibe.html','_blank','width=600,height=500,scrollbars=yes,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no');
}

// COMUNIDAD - LIBRO DE VISITAS
function visualizaguestbook()
{
  open('http://gbooks.melodysoft.com/WEBCUNIBE/','_blank','width=750,height=500,scrollbars=yes,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no');
}

// COMUNIDAD - LIBRO DE VISITAS
function escribeguestbook()
{
  open('http://gbooks.melodysoft.com/WEBCUNIBE/sign','_blank','width=750,height=500,scrollbars=yes,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no');
}

// NORMATIVAS
function normativas()
{
  open('normativas.html','_blank','width=602,height=500,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=no');
}

// NOVEDADES
function novedades()
{
  open('novedades.html','_blank','width=610,height=500,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=no');
}

// CONTACTANOS
function contactanos()
{
  open('contactanos.html','_blank','width=602,height=500,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=no');
}

// AYUDA - REQUERIMIENTOS - FLASH
function flashplayer()
{
 open('queesflashplayer.html','_blank','width=312,height=336,scrollbars=no,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no');
}

// AYUDA - REQUERIMIENTOS - BROWSER
function browser()
{
 open('browser.html','_blank','width=524,height=336,scrollbars=no,location=no,directories=no,status=no,menubar=no,toolbar=no,resizable=no');
}

// ADMISIÓN - PAI - MATERIAS
function materias()
{
 open('horarios/pai/materias.html','_blank','width=790,height=500,scrollbars=yes,location=no,directories=no,status=yes,menubar=no,toolbar=no,resizable=no');
}
